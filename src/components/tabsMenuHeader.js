class TabsMenuHeader extends HTMLElement {
    ...
    render () {
      ...
      `
        ...
        const newTabs = this.shadow.querySelector('.menu ul')
        const secondSvgLi = newTabs.lastElementChild 

        this.data.forEach(element => {

            const li = document.createElement('li')
            li.textContent = element.newTab;  

            newTabs.insertBefore(li, secondSvgLi); 
